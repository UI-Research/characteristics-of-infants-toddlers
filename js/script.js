...
var tooltipQuestion01 = 'The shares of children grouped by whether they are living in households that are not burdened by housing and utility costs, somewhat burdened, or severely burdened. Households that are “not burdened by housing and utility costs” are those that spend less than 30 percent of their income on selected housing and utility costs; households that are “somewhat burdened by housing and utility costs” are those that spend 30 percent or more, but less than 50 percent, of their income on selected housing and utility costs; and households that are “severely burdened by housing and utility costs” are those that spend 50 percent or more of their income on selected housing and utility costs.';			
...
function chart_06() {
	d3.csv("data/chart06_cbsa_data_v2.csv", function(data) {					
		chart06=data;
		dataset_chart_06=[];
		var lindex=0;
		var chart06li='';
